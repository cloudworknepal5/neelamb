/**
 * Name: counter.js (Ultimate Refresh Fix)
 * Version: 11.0
 */
...
const BloggerCounter = {
    ...
    updateAndFetch: async function(elementId) {
        ...
        // सेसन चेक (केवल 'Update' रोक्नका लागि, 'Fetch' रोक्न होइन)
        const hasVisited = sessionStorage.getItem("v_" + postId);

        try {
            // १. पहिले डेटाबेसबाट डाटा तान्ने (रिफ्रेस गर्दा पनि यो चल्छ)
            ...
            if (data !== null) {
                ...
                else if (typeof data === 'object') count = parseInt(Object.values(data)[0]) || 0;
                else count = parseInt(data) || 0;
            }

            // २. यदि यो नयाँ सेसन हो भने मात्र १ थप्ने र डेटाबेसमा पठाउने
            if (!hasVisited) {
                count = count + 1;
                await fetch(url, {
                    method: 'PUT',
            ...
            // ३. डिस्प्ले गर्ने (यो जहिले पनि चल्छ)
            if (el) {
                ...
                el.innerHTML = `${eyeIcon} <span style="font-weight:700; color:#333;">${this.toNepali(count)} पटक हेरियो</span>`;
            }
        } catch (error) {
