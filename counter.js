 ...
 * Feature: Prevents count increase on refresh (Session-based)
 */
const BloggerCounter = {
    ...
    updateAndFetch: async function(elementId) {
        ...
        // चेक गर्ने: के यो सेसनमा पहिले नै गणना भइसकेको छ?
        const isCounted = sessionStorage.getItem("counted_" + postId);
        ...
        try {
            ...
            if (!isCounted) {
                // यदि नयाँ सेसन हो भने मात्र १ थप्ने
                count = count + 1;
                await fetch(url, {
                    method: 'PUT',
                    body: JSON.stringify(count)
                });
                // सेसनमा सेभ गर्ने ताकि रिफ्रेस गर्दा नबढोस्
                sessionStorage.setItem("counted_" + postId, "true");
            }
